...
# MAGIC
# MAGIC <img src="https://github.com/databricks-demos/dbdemos-resources/blob/main/images/product/chatbot-rag/llm-rag-self-managed-flow-2.png?raw=true" style="float: right; margin-left: 10px"  width="750px;">
# MAGIC
# MAGIC Our Vector Search Index is now ready!
# MAGIC
# MAGIC Let's now create a more advanced langchain model to perform RAG.
# MAGIC
# MAGIC The flow will be:
# MAGIC
...
# MAGIC
# MAGIC We will also improve our langchain model with the following:
# MAGIC
...
# MAGIC - Within the full chain, create a retriever to create the input question embedding chain, and query the self-managed Vector Search Index to find similar documents
# MAGIC
...
# MAGIC To run this demo, just select the cluster `dbdemos-llm-rag-chatbot-tian_tan` from the dropdown menu ([open cluster configuration](https://e2-demo-field-eng.cloud.databricks.com/#setting/clusters/0429-235349-gqpr1139/configuration)). <br />
...
# MAGIC %md
# MAGIC   
# MAGIC ###  This demo requires a PERSONAL ACCESS TOKEN (PAT) to work:
# MAGIC Your Model Serving Endpoint needs a PAT to authenticate against your Vector Search Index (see [Documentation](https://docs.databricks.com/en/security/secrets/secrets.html)).  <br/>
# MAGIC
# MAGIC
...
# MAGIC %md
# MAGIC For production use, you should use a secret instead. 
...
# MAGIC
# MAGIC *Run the following to make sure your service principal has access to the Vector Search index:*
# MAGIC
# MAGIC ```
...
## for production use, consider to use secret instead
